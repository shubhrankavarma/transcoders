...
type Properties struct {
	Port                  string `env:"TRANSCODERS_SRV_PORT" env-default:"8007" hashicorp:"TRANSCODERS_SRV_PORT"`
	Host                  string `env:"TRANSCODERS_HOST" env-default:"0.0.0.0" hashicorp:"TRANSCODERS_HOST"`
